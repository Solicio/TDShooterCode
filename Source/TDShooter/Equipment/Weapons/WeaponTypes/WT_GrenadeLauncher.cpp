...
#include "TDShooter.h"
#include "WT_GrenadeLauncher.h"


AWT_GrenadeLauncher::AWT_GrenadeLauncher()
{
	// Set the weapon type.
	WeaponType = EWeaponTypes::WT_GrenadeLauncher;
}

// Called when the game starts or when spawned
void AWT_GrenadeLauncher::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWT_GrenadeLauncher::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

bool AWT_GrenadeLauncher::FireWeapon(AActor* InstigatorActor, EFactions Faction)
{
...
bool AWT_GrenadeLauncher::SpawnGLProjectile(int32 InProjectileAmount, float InProjectileSpeed, UClass* ProjectileBP, AActor* InstigatorActor, EFactions Faction)
{
