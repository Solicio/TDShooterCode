...
#include "TDShooter.h"
#include "WT_AssaultRifle.h"


AWT_AssaultRifle::AWT_AssaultRifle()
{
	// Set the weapon type.
	WeaponType = EWeaponTypes::WT_AssaultRifle;
}

// Called when the game starts or when spawned
void AWT_AssaultRifle::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWT_AssaultRifle::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

bool AWT_AssaultRifle::FireWeapon(AActor* InstigatorActor, EFactions Faction)
{
...
bool AWT_AssaultRifle::SpawnARProjectile(int32 InProjectileAmount, float InProjectileSpeed, UClass* ProjectileBP, AActor* InstigatorActor, EFactions Faction)
{
