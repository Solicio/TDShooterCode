...
#include "TDShooter.h"
#include "WT_RocketLauncher.h"


AWT_RocketLauncher::AWT_RocketLauncher()
{
	// Set the weapon type.
	WeaponType = EWeaponTypes::WT_RocketLauncher;
}

// Called when the game starts or when spawned
void AWT_RocketLauncher::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWT_RocketLauncher::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

bool AWT_RocketLauncher::FireWeapon(AActor* InstigatorActor, EFactions Faction)
{
...
bool AWT_RocketLauncher::SpawnRLProjectile(int32 InProjectileAmount, float InProjectileSpeed, UClass* ProjectileBP, AActor* InstigatorActor, EFactions Faction)
{
